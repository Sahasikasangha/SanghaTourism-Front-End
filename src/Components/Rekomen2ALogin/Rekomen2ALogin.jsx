            ...
            <div className="box-area">
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../KarimunLogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../BandenganLogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../WidaraPayunglogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../KarangPandanLogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../KarangJahelogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../Nampulogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../BapongLogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../MengantiLogin')}>Selengkapnya</button>
                    </div>
                </div>
                ...
                <div className="box">
                    ...
                    <div className="overlay">
                        ...
                        <button onClick={() => Navigate('../../LogendingLogin')}>Selengkapnya</button>
                    </div>
                </div>
                
            </div>
            <button onClick={() => Navigate('../../Eksplore2ALogin')} className='btn2'>Lainnya</button>
        </div>
    </div>
    </div>
  )
