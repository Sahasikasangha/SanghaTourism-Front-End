            ...
            <div className="destination_card">
                ...
                <div className="destination_detail">
                    <div>
                        ...
                        <button className='btn' onClick={() => Navigate('../../Karimun')}>Selengkapnya</button>
                    </div>
                </div>
            </div>
            ...
            <div className="destination_card">
                ...
                <div className="destination_detail">
                    <div>
                        ...
                        <button className='btn' onClick={() => Navigate('../../Menganti')}>Selengkapnya</button>
                    </div>
                </div>
            </div> 
            ...
            <div className="destination_card">
                ...
                <div className="destination_detail">
                    <div>
                        ...
                        <button className='btn' onClick={() => Navigate('../../Logending')}>Selengkapnya</button>
                    </div>
                </div>
            </div>         
        </div>
